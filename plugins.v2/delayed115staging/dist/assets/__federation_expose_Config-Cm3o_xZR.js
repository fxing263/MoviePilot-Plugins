...
import { _ as _export_sfc, P as PLUGIN_ID, n as normalizeConfig, v as validateAndSave } from './_plugin-vue_export-helper-BzYaA2YH.js';
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _cache[25] || (_cache[25] = _createElementVNode("div", { class: "text-h6 mb-3" }, "115 延迟暂存配置", -1)),
    (error.value)
    ...
    _createElementVNode("fieldset", {
      ...
      _createVNode(_component_v_select, {
        modelValue: config.confirmation_mode,
        "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => ((config.confirmation_mode) = $event)),
        label: "上传成功确认方式",
        items: confirmationModes,
        hint: "自动确认仅适用于以此模式新建的任务；切回手动会暂停已有任务的自动确认。",
        "persistent-hint": "",
        class: "mb-3"
      }, null, 8, ["modelValue"]),
      (config.confirmation_mode === 'staging_deleted')
        ? (_openBlock(), _createBlock(_component_v_alert, {
            key: 0,
            type: "warning",
            variant: "tonal",
        ...
        : (_openBlock(), _createBlock(_component_v_alert, {
            ...
            default: _withCtx(() => [...(_cache[19] || (_cache[19] = [
              _createTextVNode("在任务页核验远端文件后手动确认，或由上传器提交明确的成功回执，再执行清理。", -1)
            ]))]),
            _: 1
          })),
      _createVNode(_component_v_switch, {
        modelValue: config.scan_once,
        "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => ((config.scan_once) = $event)),
        label: "进行一次全量硬链接",
        color: "warning",
        "hide-details": ""
      }, null, 8, ["modelValue"]),
      ...
      _createVNode(_component_v_text_field, {
        ...
        "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((config.history_days) = $event)),
        modelModifiers: { number: true },
        type: "number",
        min: "1",
        max: "3650",
      ...
      _createVNode(_component_v_switch, {
        ...
        "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((config.cleanup_organized) = $event)),
      ...
      _createVNode(_component_v_switch, {
        ...
        "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((config.cleanup_empty_dirs) = $event)),
